...
import info.zthings.libgdxglue.GdxGlue;
...
public class Logger {
	...
	public void debug (String message) {
		if (level >= DEBUG) GdxGlue.app.debug(tag, message);
	}

	public void debug (String message, Exception exception) {
		if (level >= DEBUG) GdxGlue.app.debug(tag, message, exception);
	}

	public void info (String message) {
		if (level >= INFO) GdxGlue.app.log(tag, message);
	}

	public void info (String message, Exception exception) {
		if (level >= INFO) GdxGlue.app.log(tag, message, exception);
	}

	public void error (String message) {
		if (level >= ERROR) GdxGlue.app.error(tag, message);
	}

	public void error (String message, Throwable exception) {
		if (level >= ERROR) GdxGlue.app.error(tag, message, exception);
	}
